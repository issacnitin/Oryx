...
namespace Microsoft.Oryx.BuildScriptGeneratorCli.Tests
{
    public class BuildCommandTest : IClassFixture<TestTempDirTestFixture>
    {
        ...
        [Fact]
        public void OptionsHasValueFromEnvVariable_OverValueFromBuildEnvFile()
        {
        }

        [Fact]
        public void OptionsHasValueFromCommandLine_OverValueFromEnvVariable()
        {
        }
        ...
        [Fact]
        public void OptionsHasValueFromEnvVariable_IfNoValueFoundFromOtherSources()
        {
        }
